...
2) Меняем права доступа с помощью chmod
3) Создаем пустые текстовые файлы:
 ![изображение](https://github.com/user-attachments/assets/79e7cf0a-02cf-42e3-9da0-10abcc85c10d)

4) очищаю staging area, чтобы Git не выдавал ошибку старых файлов перед коммитом новых и добавляю "правильный" файл:
